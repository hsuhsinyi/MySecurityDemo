...
public class PostNumbersAdapter extends SimpleAdapter {
	...
	public PostNumbersAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mLayoutInflater.inflate(R.layout.listview_commonpost,
					null);
			holder = new ViewHolder();
			holder.districtName = (TextView) convertView
					.findViewById(R.id.district_name);
			holder.postCode = (TextView) convertView.findViewById(R.id.post_code);
		} else {
			holder = (ViewHolder) convertView.getTag();
		}
		convertView.setTag(holder);
		holder.districtName.setText(mlist.get(position).get("name").toString());
		holder.postCode.setText(mlist.get(position).get("code").toString());
		return convertView;
	}
